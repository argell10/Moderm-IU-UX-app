...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      {/* Discount */}
      <div className="flex flex-row items-center py-[6px] px-4 bg-gradient-to-r from-slate-700 rounded-[10px] mb-2">
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      ...
      <div className="absolute z-[1] w-[80%] h-[80%] rounded-full button-40 white__gradient"/>
